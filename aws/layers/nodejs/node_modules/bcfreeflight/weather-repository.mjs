...
class DynamoDBWeatherRepository {
     ...
     * @param {string} params.deviceId The device id associated with the weather data.
     ...
     */
    async saveWeatherData({ id, deviceId, timestamp, data }) {
        let payload = { id, deviceId, timestamp, data };
