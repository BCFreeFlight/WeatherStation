...
class WeatherService {
     ...
     *
     * @param {string} deviceId - The key associated with the weather data upload.
     ...
     */
    async saveWeatherData(deviceId, data) {
        const timestamp = new Date().toISOString();
        const id = nanoid();
        return await this.weatherRepository.saveWeatherData({id, deviceId, timestamp, data});
    }
}
